...
<p align="center">
    <img src="https://github.com/corbtastik/todos-images/raw/master/todos-ui/todos-ui.png">
</p>

If running Todo(s) UI in offline mode (i.e. ``/api`` 404'd) the Todo(s) entered will be saved to a local array and lost when the browser closes.  Todo(s) UI will connect with Todo(s) Gateway if running locally and if Todo(s) API is also running then we can save Todo(s) entered from the browser.
